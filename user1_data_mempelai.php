              ...
              <table border="1" cellspacing="0" class="table">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="user1_edit_data_mempelai.php?id=<?php echo $row['id_mempelai'] ?>">edit</a> || <a href="user1_proses_hapus.php?idm=<?php echo $row['id_mempelai'] ?>" onclick="return confirm('Yakin ingin Hapus ?')">hapus</a>
                    </td>
                  </tr>
                  <?php }}else{ ?>
                      <tr>
