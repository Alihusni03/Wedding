      ...
      <div class="main-content">
        ...
        <div class="section">
          <div class="dashboard-box">
            <h3>Data Lokasi</h3>
            <div class="box">
              <p><a href="tambah_dalil.php">Tambah Data</a></p>
              <table border="1" cellspacing="0" class="table">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="edit_dalil.php?id=<?php echo $row['id_dalil'] ?>">edit</a> || <a href="proses_hapus.php?idd=<?php echo $row['id_dalil'] ?>" onclick="return confirm('Yakin ingin Hapus ?')">hapus</a>
                    </td>
                  </tr>
                  <?php }}else{ ?>
                      <tr>
