<?php
  ...
  $profile = mysqli_query($conn, "SELECT * FROM tb_profile WHERE id_profile = '".$_GET['id']."' ");
      ...
      <div class="main-content">
        ...
        <div class="section">
          <div class="dashboard-box">
            <h3>Edit Data Mempelai Pria</h3>
            <div class="box">
                <p><a href="user1_data_profile.php">back</a></p>
                <form action="" method="POST" enctype="multipart/form-data">
                    
                    <input type="text" name="cowo" value="<?php echo $p->nama_lengkap_pria ?>" class="input-control" placeholder="Nama Cowo" required>
                    <input type="text" name="ayah" value="<?php echo $p->nama_lengkap_ayah ?>" class="input-control" placeholder="Nama Ayah" required>
                    <input type="text" name="ibu" value="<?php echo $p->nama_lengkap_ibu ?>" class="input-control" placeholder="Nama Ibu" required>
                    <img src="produk/<?php echo $p->img_profile?>" width="100px">
                    <input type="hidden" name="foto" value="<?php echo $p->img_profile ?>">
