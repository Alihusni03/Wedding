      ...
      <div class="main-content">
        ...
        <div class="section">
          <div class="dashboard-box">
            <h3>Tambah Data Mempelai Pria</h3>
            <div class="box">
                <p><a href="data_profile.php">back</a></p>
                <form action="" method="POST" enctype="multipart/form-data">
                    
                    <input type="text" name="cowo" class="input-control" placeholder="Nama Mempelai Pria" required>
                    <input type="text" name="ayah" class="input-control" placeholder="Nama Ayah Mempelai Pria" required>
                    <input type="text" name="ibu" class="input-control" placeholder="Nama Ibu Mempelai Pria" required>
                ...
                <?php
                    if(isset($_POST['submit'])){
                        ...
                        if(!in_array($type2, $tipe_diizinkan)){
                          ...
                          $insert = mysqli_query($conn, "INSERT INTO tb_profile VALUES (
                                      null,
                                      '".$cowo."',
                                      '".$ayah."',
                                      '".$ibu."',                        
