<?php
  ...
  $waktu = mysqli_query($conn, "SELECT * FROM tb_waktu WHERE id_waktu = '".$_GET['id']."' ");
  $w = mysqli_fetch_object($waktu);
          ...
          <div class="dashboard-box">
            ...
            <div class="box">
                ...
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <input type="text" name="mulai" value="<?php echo $w->mulai ?>" class="input-control" placeholder="mulai waktu" required>
                    <input type="text" name="selesai" value="<?php echo $w->selesai ?>" class="input-control" placeholder="waltu selesai" required>
                    <input type="text" name="hari" value="<?php echo $w->hari ?>" class="input-control" placeholder="hari" required>
                    <input type="text" name="bulan" value="<?php echo $w->bulan?>" class="input-control" placeholder="Bulan" required>
                    <input type="text" name="lokasi" value="<?php echo $w->lokasi?>" class="input-control" placeholder="lokasi" required>
                ...
                <?php
                    if(isset($_POST['submit'])){
                        ...
                        $status      = $_POST['status'];
                          ...
                          $update = mysqli_query($conn, "UPDATE tb_waktu SET 
                                      mulai = '".$mulai."',
                                      selesai = '".$selesai."',
                                      hari = '".$hari."',
                                      bulan = '".$bulan."',
