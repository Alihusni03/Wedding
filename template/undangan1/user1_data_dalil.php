              ...
              <table border="1" cellspacing="0" class="table">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="edit_dalil.php?id=<?php echo $row['id_dalil'] ?>">edit</a> || <a href="user1_proses_hapus.php?idd=<?php echo $row['id_dalil'] ?>" onclick="return confirm('Yakin ingin Hapus ?')">hapus</a>
                    </td>
                  </tr>
                  <?php }}else{ ?>
                      <tr>
