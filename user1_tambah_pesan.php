      ...
      <div class="main-content">
        ...
        <div class="section">
          <div class="dashboard-box">
            <h3>Tambah Data Pesan</h3>
            <div class="box">
                <p><a href="user1_data_pesan.php">back</a></p>
                <form action="" method="POST" enctype="multipart/form-data">
                    
                    <input type="text" name="nama" class="input-control" placeholder="Nama Pengirim" required>
                    <input type="text" name="pesan" class="input-control" placeholder="Pesan Pengirim" required>
