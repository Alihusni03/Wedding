      ...
      <div class="main-content">
        ...
        <div class="section">
          <div class="dashboard-box">
            <h3>Data Mempelai</h3>
            <div class="box">
              <p><a href="tambah_mempelai.php">Tambah Data</a></p>
              <table border="1" cellspacing="0" class="table">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="edit_mempelai.php?id=<?php echo $row['id_mempelai'] ?>">edit</a> || <a href="proses_hapus.php?idm=<?php echo $row['id_mempelai'] ?>" onclick="return confirm('Yakin ingin Hapus ?')">hapus</a>
                    </td>
                  </tr>
                  <?php }}else{ ?>
                      <tr>
