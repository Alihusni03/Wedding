      ...
      <div class="main-content">
        ...
        <div class="section">
          <div class="dashboard-box">
            ...
            <h4>Akad Nikah</h4>
            <div class="box">
              <p><a href="user1_tambah_akad.php">Tambah Data</a></p>
              <table border="1" cellspacing="0" class="table">
                ...
                <tbody>
                  <?php
                    $no = 1;
                    $waktu = mysqli_query($conn, "SELECT * FROM tb_waktu LEFT JOIN tb_mempelai USING (id_mempelai) ORDER BY id_waktu DESC");
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="user1_edit_data_akad.php?id=<?php echo $row['id_waktu'] ?>">edit</a> || <a href="user1_proses_hapus.php?idwa=<?php echo $row['id_waktu'] ?>" onclick="return confirm('Yakin ingin Hapus ?')">hapus</a>
                    </td>
                  </tr>
                  <?php }}else{ ?>
                      <tr>
            ...
            <h4>Resepsi</h4>
            <div class="box">
              <p><a href="user1_tambah_resepsi.php">Tambah Data</a></p>
              <table border="1" cellspacing="0" class="table">
                <thead>
                  <tr>
                    <th width="60px">No</th>
                ...
                <tbody>
                  <?php
                    $no = 1;
                    $waktu1 = mysqli_query($conn, "SELECT * FROM tb_waktu1 LEFT JOIN tb_mempelai USING (id_mempelai) ORDER BY id_waktu1 DESC");
                  ...
                  <tr>
                    ...
                    <td><?php echo $row['status'] ?></td>
                    <td>
                      <a href="user1_edit_data_resepsi.php?id=<?php echo $row['id_waktu1'] ?>">edit</a> || <a href="user1_proses_hapus.php?idwr=<?php echo $row['id_waktu1'] ?>" onclick="return confirm('Yakin ingin Hapus ?')">hapus</a>
                    </td>
                  </tr>
                  <?php }}else{ ?>
                      <tr>
