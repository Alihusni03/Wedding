      ...
      <div class="main-content">
        ...
        <div class="section">
          <div class="dashboard-box">
            <h3>Partner</h3>
            <div class="box">
              <p><a href="tambah_partner.php">Tambah Data</a></p>
              <table border="1" cellspacing="0" class="table">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><img src="produk/<?php echo $row['img_partner'] ?>" width="30px"></td>
                    <td><?php echo $row['detail'] ?></td>
                    <td>
                      <a href="edit_partner.php?id=<?php echo $row['id_partner'] ?>">edit</a> || <a href="proses_hapus.php?idpa=<?php echo $row['id_partner'] ?>" onclick="return confirm('Yakin ingin Hapus ?')">hapus</a>
                    </td>
                  </tr>
                  <?php }}else{ ?>
                      <tr>
