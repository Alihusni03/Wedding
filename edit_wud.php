<?php
  ...
  $fitur = mysqli_query($conn, "SELECT * FROM tb_fitur WHERE id_fitur = '".$_GET['id']."' ");
          ...
          <div class="dashboard-box">
            ...
            <div class="box">
                ...
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <input type="text" name="judul" value="<?php echo $f->judul_wud ?>" class="input-control" placeholder=Judul required>
                    <input type="text" name="isi" value="<?php echo $f->isi_wud ?>" class="input-control" placeholder="Isi" required>
                    <img src="produk/<?php echo $f->img_wud?>" width="100px">
                    <input type="hidden" name="foto" value="<?php echo $f->img_wud ?>">
                ...
                <?php
                    ...
                    if($filename != ''){
                        ...
                        if(!in_array($type2, $tipe_diizinkan)){
                          ...
                          $update = mysqli_query($conn, "UPDATE tb_fitur SET 
                                      judul_wud = '".$judul."',
                                      isi_wud = '".$isi."',
                                      img_wud = '".$namagambar."'
                                      WHERE id_fitur = '".$f->id_fitur."' ");
                          if($update){
