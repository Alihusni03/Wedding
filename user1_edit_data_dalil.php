<?php 
  ...
  include 'db_user1.php';
    ...
    $dalil = mysqli_query($conn, "SELECT * FROM tb_dalil WHERE id_dalil = '".$_GET['id']."' ");
    $d = mysqli_fetch_object($dalil); 
?>
      ...
      <div class="main-content">
        ...
        <div class="section">
          <div class="dashboard-box">
            <h3>Edit Data Dalil</h3>
            <div class="box">
                <p><a href="user1_data_dalil.php">back</a></p>
                <form action="" method="POST" enctype="multipart/form-data">
                    <input type="text" name="judul" class="input-control" placeholder="Link Denah Akad Anda" value="<?php echo $d->judul?>" required>
                    <input type="text" name="dalil" class="input-control" placeholder="Link Denah Akad Anda" value="<?php echo $d->dalil?>" required>
                ...
                <?php
                    if(isset($_POST['submit'])){
                        ...
                        $status      = $_POST['status'];
                          ...
                          $update = mysqli_query($conn, "UPDATE tb_dalil SET 
                                      judul = '".$judul."',
                                      dalil = '".$jauh."',
                                      id_mempelai = '".$status."'
                                      WHERE id_dalil = '".$d->id_dalil."' ");
