      ...
      <div class="main-content">
        ...
        <div class="section">
          <div class="dashboard-box">
            <h3>Ajakan</h3>
            <div class="box">
              <!-- <p><a href="tambah_ajakan.php">Tambah Data</a></p> -->
              <table border="1" cellspacing="0" class="table">
                ...
                <tbody>
                  <?php
                    ...
                    while($row = mysqli_fetch_array($ajakan)){
                  ?>
                  <tr>
                    <td><?php echo $no++ ?></td>
                    <td><?php echo $row['ajakan_deskripsi'] ?></td>
                    <td><img src="produk/<?php echo $row['img_ajakan'] ?>" width="30px"></td>
                    <td>
                      <a href="edit_ajakan.php?id=<?php echo $row['id_ajakan'] ?>">edit</a>
                    </td>
                  </tr>
                  <?php }}else{ ?>
                      <tr>
