            ...
            <div class="box">
              ...
              <table border="1" cellspacing="0" class="table">
                ...
                <tbody>
                  <?php
                    $no = 1;
                    $profile = mysqli_query($conn, "SELECT * FROM tb_profile  LEFT JOIN tb_mempelai USING (id_mempelai) ORDER BY id_profile DESC");
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="user1_edit_profile_pria.php?id=<?php echo $row['id_profile'] ?>">edit</a> || <a href="user1_proses_hapus.php?idp=<?php echo $row['id_profile'] ?>" onclick="return confirm('Yakin ingin Hapus ?')">hapus</a>
                    </td>
                  </tr>
                  <?php }}else{ ?>
                      <tr>
            ...
            <div class="box">
              ...
              <table border="1" cellspacing="0" class="table">
                ...
                <tbody>
                  <?php
                    $no = 1;
                    $profile1 = mysqli_query($conn, "SELECT * FROM tb_profile1 LEFT JOIN tb_mempelai USING (id_mempelai) ORDER BY id_profile1 DESC");
                  ...
                  <tr>
                    ...
                    <td><?php echo $row['status'] ?></td>
                    <td>
                      <a href="user1_edit_Profile_wanita.php?id=<?php echo $row['id_profile1'] ?>">edit</a> || <a href="user1_proses_hapus.php?idp1=<?php echo $row['id_profile1'] ?>" onclick="return confirm('Yakin ingin Hapus ?')">hapus</a>
                    </td>
                  </tr>
                  <?php }}else{ ?>
                      <tr>
            ...
            <div class="box">
              ...
              <table border="1" cellspacing="0" class="table">
                ...
                <tbody>
                  <?php
                    $no = 1;
                    $profile2 = mysqli_query($conn, "SELECT * FROM tb_profile2 LEFT JOIN tb_mempelai USING (id_mempelai) ORDER BY id_profile2 DESC");
                  ...
                  <tr>
                    ...
                    <td><?php echo $row['status'] ?></td>
                    <td>
                      <a href="user1_edit_profile.php?id=<?php echo $row['id_profile2'] ?>">edit</a> || <a href="user1_proses_hapus.php?idp2=<?php echo $row['id_profile2'] ?>" onclick="return confirm('Yakin ingin Hapus ?')">hapus</a>
                    </td>
                  </tr>
                  <?php }}else{ ?>
                      <tr>
