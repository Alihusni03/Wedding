<?php
  ...
  $fitur2 = mysqli_query($conn, "SELECT * FROM tb_fitur2 WHERE id_fitur2 = '".$_GET['id']."' ");
          ...
          <div class="dashboard-box">
            ...
            <div class="box">
                ...
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <input type="text" name="judul" value="<?php echo $f2->judul_p ?>" class="input-control" placeholder=Judul required>
                    <input type="text" name="isi" value="<?php echo $f2->isi_p ?>" class="input-control" placeholder="Isi" required>
                    <img src="produk/<?php echo $f2->img_p?>" width="100px">
                    <input type="hidden" name="foto" value="<?php echo $f2->img_p ?>">
                ...
                <?php
                    ...
                    if($filename != ''){
                        ...
                        if(!in_array($type2, $tipe_diizinkan)){
                          ...
                          $update = mysqli_query($conn, "UPDATE tb_fitur2 SET 
                                      judul_p = '".$judul."',
                                      isi_p = '".$isi."',
                                      img_p = '".$namagambar."'
                                      WHERE id_fitur2 = '".$f2->id_fitur2."' ");
                          if($update){
