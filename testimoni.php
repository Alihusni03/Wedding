      ...
      <div class="main-content">
        ...
        <div class="section">
          <div class="dashboard-box">
            <h3>Testimoni</h3>
            <div class="box">
              <p><a href="tambah_testimoni.php">Tambah Data</a></p>
              <table border="1" cellspacing="0" class="table">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><?php echo $row['gelar_testimoni'] ?></td>
                    <td><img src="produk/<?php echo $row['img_testimoni'] ?>" width="50px"></td>
                    <td>
                      <a href="edit_testimoni.php?id=<?php echo $row['id_testimoni'] ?>">edit</a> || <a href="proses_hapus.php?idt=<?php echo $row['id_testimoni'] ?>" onclick="return confirm('Yakin ingin Hapus ?')">hapus</a>
                    </td>
                  </tr>
                  <?php }}else{ ?>
                      <tr>
