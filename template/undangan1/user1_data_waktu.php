              ...
              <table border="1" cellspacing="0" class="table">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="edit_waktu.php?id=<?php echo $row['id_waktu'] ?>">edit</a> || <a href="user1_proses_hapus.php?idwa=<?php echo $row['id_waktu'] ?>" onclick="return confirm('Yakin ingin Hapus ?')">hapus</a>
                    </td>
                  </tr>
                  <?php }}else{ ?>
                      <tr>
              ...
              <table border="1" cellspacing="0" class="table">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><?php echo $row['lokasi'] ?></td>
                    <td>
                      <a href="edit_waktu.php?id=<?php echo $row['id_waktu1'] ?>">edit</a> || <a href="user1_proses_hapus.php?idwr=<?php echo $row['id_waktu1'] ?>" onclick="return confirm('Yakin ingin Hapus ?')">hapus</a>
                    </td>
                  </tr>
                  <?php }}else{ ?>
                      <tr>
