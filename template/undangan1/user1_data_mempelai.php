      ...
      <div class="main-content">
        ...
        <div class="section">
          <div class="dashboard-box">
            <h3>Data Mempelai</h3>
            <div class="box">
              <p><a href="user1_tambah_mempelai.php">Tambah Data</a></p>
              <table border="1" cellspacing="0" class="table">
                ...
                <tbody>
                  <?php
                    ...
                    while($row = mysqli_fetch_array($mempelai)){
                  ?>
                  <tr>
                    <td><?php echo $no++ ?></td>
                    <td><?php echo $row['nama_cowo'] ?></td>
                    <td><?php echo $row['nama_cewe'] ?></td>
                    <td><?php echo $row['tanggal_mundur'] ?></td>
                    <td><?php echo $row['qr_code'] ?></td>
                    <td><img src="produk/<?php echo $row['img_mempelai']?>" width="30px"></td>
                    <td>
                      <a href="edit_mempelai.php?id=<?php echo $row['id_mempelai'] ?>">edit</a> || <a href="user1_proses_hapus.php?idm=<?php echo $row['id_mempelai'] ?>" onclick="return confirm('Yakin ingin Hapus ?')">hapus</a>
                    </td>
                  </tr>
                  <?php }}else{ ?>
                      <tr>
