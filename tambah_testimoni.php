      ...
      <div class="main-content">
        ...
        <div class="section">
          <div class="dashboard-box">
            <h3>Tambah Data Testimonni</h3>
            <div class="box">
                <p><a href="testimoni.php">back</a></p>
                <form action="" method="POST" enctype="multipart/form-data">
                    
                    <input type="text" name="isi" class="input-control" placeholder="Isi" required>
                    <input type="text" name="nama" class="input-control" placeholder="Nama" required>
                    <input type="text" name="gelar" class="input-control" placeholder="Gelar" required>
                ...
                <?php
                    if(isset($_POST['submit'])){
                        ...
                        if(!in_array($type2, $tipe_diizinkan)){
                          ...
                          $insert = mysqli_query($conn, "INSERT INTO tb_testimoni VALUES (
                                      null,
                                      '".$isi."',
                                      '".$nama."',
                                      '".$newname."',
