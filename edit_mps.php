<?php
  ...
  $fitur3 = mysqli_query($conn, "SELECT * FROM tb_fitur3 WHERE id_fitur3 = '".$_GET['id']."' ");
          ...
          <div class="dashboard-box">
            ...
            <div class="box">
                ...
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <input type="text" name="judul" value="<?php echo $f3->judul_mps ?>" class="input-control" placeholder=Judul required>
                    <input type="text" name="isi" value="<?php echo $f3->isi_mps ?>" class="input-control" placeholder="Isi" required>
                    <img src="produk/<?php echo $f3->img_mps?>" width="100px">
                    <input type="hidden" name="foto" value="<?php echo $f3->img_mps ?>">
                ...
                <?php
                    ...
                    if($filename != ''){
                        ...
                        if(!in_array($type2, $tipe_diizinkan)){
                          ...
                          $update = mysqli_query($conn, "UPDATE tb_fitur3 SET 
                                      judul_mps = '".$judul."',
                                      isi_mps = '".$isi."',
                                      img_mps = '".$namagambar."'
                                      WHERE id_fitur3 = '".$f3->id_fitur3."' ");
                          if($update){
