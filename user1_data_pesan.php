      ...
      <div class="main-content">
        ...
        <div class="section">
          <div class="dashboard-box">
            <h3>Data Tamu Pesan</h3>
            <div class="box">
              <!-- <p><a href="user1_tambah_pesan.php">Tambah Data</a></p> -->
              <table border="1" cellspacing="0" class="table">
                ...
                <tbody>
                  <?php
                    $no = 1;
                    $pesan = mysqli_query($conn, "SELECT * FROM tb_pesan LEFT JOIN tb_mempelai USING (id_mempelai) ORDER BY id_pesan DESC");
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="user1_proses_hapus.php?idpe=<?php echo $row['id_pesan'] ?>" onclick="return confirm('Yakin ingin Hapus ?')">hapus</a>
                    </td>
                  </tr>
                  <?php }}else{ ?>
                      <tr>
