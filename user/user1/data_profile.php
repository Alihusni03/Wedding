      ...
      <div class="main-content">
        ...
        <div class="section">
          <div class="dashboard-box">
            ...
            <div class="box">
              <p><a href="tambah_profile_pria.php">Tambah Data</a></p>
              <table border="1" cellspacing="0" class="table">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="edit_profile_pria.php?id=<?php echo $row['id_profile'] ?>">edit</a> || <a href="proses_hapus.php?idp=<?php echo $row['id_profile'] ?>" onclick="return confirm('Yakin ingin Hapus ?')">hapus</a>
                    </td>
                  </tr>
                  <?php }}else{ ?>
                      <tr>
            ...
            <div class="box">
              <p><a href="tambah_profile_wanita.php">Tambah Data</a></p>
              <table border="1" cellspacing="0" class="table">
                <thead>
                  <tr>
                    <th width="60px">No</th>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><img src="produk/<?php echo $row['img_profile']?>" width="30px"></td>
                    <td>
                      <a href="edit_Profile_wanita.php?id=<?php echo $row['id_profile1'] ?>">edit</a> || <a href="proses_hapus.php?idp1=<?php echo $row['id_profile1'] ?>" onclick="return confirm('Yakin ingin Hapus ?')">hapus</a>
                    </td>
                  </tr>
                  <?php }}else{ ?>
                      <tr>
            ...
            <div class="box">
              <p><a href="tambah_profile.php">Tambah Data</a></p>
              <table border="1" cellspacing="0" class="table">
                <thead>
                  <tr>
                    <th width="60px">No</th>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="edit_profile.php?id=<?php echo $row['id_profile2'] ?>">edit</a> || <a href="proses_hapus.php?idp2=<?php echo $row['id_profile2'] ?>" onclick="return confirm('Yakin ingin Hapus ?')">hapus</a>
                    </td>
                  </tr>
                  <?php }}else{ ?>
                      <tr>
