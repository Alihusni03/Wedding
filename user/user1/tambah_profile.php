      ...
      <div class="main-content">
        ...
        <div class="section">
          <div class="dashboard-box">
            <h3>Tambah Data Tanggal</h3>
            <div class="box">
                <p><a href="data_profile.php">back</a></p>
                <form action="" method="POST" enctype="multipart/form-data">
                    <input type="text" name="tanggal" class="input-control" placeholder="Tanggal Pernikahan" required>
                ...
                <?php
                    if(isset($_POST['submit'])){
                        ...
                        $tanggal      = $_POST['tanggal'];
                          ...
                          $insert = mysqli_query($conn, "INSERT INTO tb_profile2 VALUES (
                                      null,
                                      '".$tanggal."'
                                          ) ");
