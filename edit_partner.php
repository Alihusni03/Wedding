<?php
  ...
  $partner = mysqli_query($conn, "SELECT * FROM tb_partner WHERE id_partner = '".$_GET['id']."' ");
  $pa = mysqli_fetch_object($partner);
          ...
          <div class="dashboard-box">
            ...
            <div class="box">
                ...
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <input type="text" name="partner" class="input-control" placeholder="Link Sosial Media" value="<?php echo $pa->partner?>" required>
                    <img src="produk/<?php echo $pa->img_partner?>" width="100px">
                    <input type="hidden" name="foto" value="<?php echo $pa->img_partner ?>">
                    <input type="file" name="gambar" class="input-control" required>
                    <input type="text" name="detail" class="input-control" placeholder="detail" value="<?php echo $pa->detail?>" required>
                ...
                <?php
                    if(isset($_POST['submit'])){
                        ...
                        if($filename != ''){
                          ...
                          $update = mysqli_query($conn, "UPDATE tb_partner SET 
                                      partner = '".$partner."',
                                      img_partner = '".$namagambar."',
                                      detail = '".$detail."'
                                      WHERE id_partner = '".$pa->id_partner."' ");
                          if($update){
