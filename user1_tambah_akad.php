      ...
      <div class="main-content">
        ...
        <div class="section">
          <div class="dashboard-box">
            <h3>Tambah Data Akad</h3>
            <div class="box">
                <p><a href="user1_data_waktu.php">back</a></p>
                <form action="" method="POST" enctype="multipart/form-data">
                    
                    <input type="text" name="mulai" class="input-control" placeholder="Mulai Pukul : 07.00" required>
                    <input type="text" name="selesai" class="input-control" placeholder="Selesai Pukul : 10.00" required>
                    <input type="text" name="hari" class="input-control" placeholder="Hari & tanggal : Senin, 12" required>
                    <input type="text" name="bulan" class="input-control" placeholder="Bulan & Tahun : November, 2012" required>
                    <input type="text" name="lokasi" class="input-control" placeholder="Alamat Lokasi Anda" required>
                ...
                <?php
                    if(isset($_POST['submit'])){
                        ...
                        $status     = $_POST['status'];
                          ...
                          $insert = mysqli_query($conn, "INSERT INTO tb_waktu VALUES (
                                      null,
                                      '".$mulai."',
                                      '".$selesai."',
                                      '".$hari."',
